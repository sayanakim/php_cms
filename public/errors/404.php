...
<head>
    ...
    <!-- /font files -->
    <!-- css files -->
    <link href="/public/errors/css/style.css" rel="stylesheet" type="text/css" media="all" />
    <!-- /css files -->
    <!-- js files -->
...
<div class="container demo-2">
    <div class="content">
        <div id="large-header" class="large-header">
            ...
            <img src="/public/errors/images/owl.gif" alt="flashy" class="w3l">
...
<!-- js files -->
<script src="/public/errors/js/rAF.js"></script>
<script src="/public/errors/js/demo-2.js"></script>
<!-- /js files -->
</body>
</html>
